...
## Example 1:
    ...
    Explanation: 
        We remove the nodes 3 and 4 and put the entire 
            list2 in their place. The blue edges and nodes 
...
## Example 2:
    ...
    Explanation: 
        The blue edges and nodes in the above figure 
            indicate the result.
