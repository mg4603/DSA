...
$difference[i][j] = words[i][j+1] - words[i][j]$ where $0 \le j \le n - 2$.  
...
## Example 1:
    ...
    Output: "abc"
    Explanation: 
        - The difference integer array of "adc" is 
            [3 - 0, 2 - 3] = [3, -1].
...
## Example 2:
    ...
    Output: "bob"
    Explanation: 
        All the integer arrays are [0, 0] except for "bob", which 
