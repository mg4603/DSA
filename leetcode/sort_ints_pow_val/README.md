...
Notice that for any integer x ($lo \le x \le hi$) it is guaranteed that x  
will transform into 1 using these steps and that the power of x is will fit  
...
## Example 1:
    ...
    Explanation: 
        ...
        For k = 2 answer is the second element which 
            is 13.
        Notice that 12 and 13 have the same power value and 
            we sorted them in ascending order. Same for 14 
            and 15.
...
## Example 2:
    ...
    Output: 7
    Explanation: 
        The power array corresponding to the interval 
